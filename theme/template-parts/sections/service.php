	...
	<div class="speck-container">
		<div class="speck-section--photo__panel">
			...
			<div class="speck-hero__ctas">
				<a class="speck-btn speck-btn--primary" href="<?php echo esc_url( speck_footer_link( 'speck_service_schedule_url', 'https://www.speckdealerships.com/service' ) ); ?>">
					<?php esc_html_e( 'Schedule Service', 'speck-modern-theme' ); ?>
				</a>
				<a class="speck-btn speck-btn--outline-light" href="<?php echo esc_url( speck_footer_link( 'speck_service_parts_url', home_url( '/parts/' ) ) ); ?>">
