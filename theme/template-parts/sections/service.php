...
?>
<section class="speck-service speck-section--photo" style="background-image: linear-gradient(180deg, rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('<?php echo esc_url( speck_background_image( 'speck_service_bg', 'section-service.jpg' ) ); ?>');">
