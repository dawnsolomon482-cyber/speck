...
?>
<section class="speck-service speck-section--photo" style="background-image: url('<?php echo esc_url( speck_background_image( 'speck_service_bg', 'section-service.jpg' ) ); ?>');">
