...
?>
<section class="speck-specials speck-section--photo" style="background-image: linear-gradient(180deg, rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('<?php echo esc_url( speck_background_image( 'speck_specials_bg', 'section-specials.jpg' ) ); ?>');">
