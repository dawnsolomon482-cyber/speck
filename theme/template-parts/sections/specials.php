...
?>
<section class="speck-specials speck-section--photo" style="background-image: url('<?php echo esc_url( speck_background_image( 'speck_specials_bg', 'section-specials.jpg' ) ); ?>');">
