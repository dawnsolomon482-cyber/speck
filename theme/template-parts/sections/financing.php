...
?>
<section class="speck-financing speck-section--photo" style="background-image: linear-gradient(180deg, rgba(0,0,0,0.15), rgba(0,0,0,0.15)), url('<?php echo esc_url( speck_background_image( 'speck_financing_bg', 'section-financing.jpg' ) ); ?>');">
